...
"#rightButtons .QPushButton:pressed { background-color: rgb(235, 245, 225); border-style: solid; border-radius: 4px; }")
        ...
        self.frame_2.setStyleSheet("background-color: rgba(255, 225, 255, 10);")
...
"}")
        ...
        self.note1 = QtWidgets.QLabel(self.frame_3)
        self.note1.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(14)
        font.setBold(False)
        self.note1.setFont(font)
        self.note1.setStyleSheet("QLabel{\n"
"color: rgb(8, 255, 206);\n"
"background-color: none;\n"
"}\n"
"QLabel:hover{\n"
...
"")
        ...
        self.note1.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.note1.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextEditable|QtCore.Qt.TextSelectableByMouse)
        self.note1.setObjectName("note1")
        self.verticalLayout_3.addWidget(self.note1)
        self.horizontalLayout_2.addWidget(self.frame_3)
        self.relay1 = QtWidgets.QCheckBox(self.frame_2)
...
"}")
        ...
        self.frame_4.setStyleSheet("background-color: rgba(255, 225, 255, 10);")
...
"}")
        ...
        self.note2 = QtWidgets.QLabel(self.frame_5)
        self.note2.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(14)
        font.setBold(False)
        self.note2.setFont(font)
        self.note2.setStyleSheet("QLabel{\n"
"color: rgb(8, 255, 206);\n"
"background-color: none;\n"
"}\n"
"QLabel:hover{\n"
...
"")
        ...
        self.note2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.note2.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextEditable|QtCore.Qt.TextSelectableByMouse)
        self.note2.setObjectName("note2")
        self.verticalLayout_4.addWidget(self.note2)
        self.horizontalLayout_10.addWidget(self.frame_5)
        self.relay2 = QtWidgets.QCheckBox(self.frame_4)
...
"}")
        ...
        self.frame_8.setStyleSheet("background-color: rgba(255, 225, 255, 10);")
...
"}")
        ...
        self.note4 = QtWidgets.QLabel(self.frame_9)
        self.note4.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(14)
        font.setBold(False)
        self.note4.setFont(font)
        self.note4.setStyleSheet("QLabel{\n"
"color: rgb(8, 255, 206);\n"
"background-color: none;\n"
"}\n"
"QLabel:hover{\n"
...
"")
        ...
        self.note4.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.note4.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextEditable|QtCore.Qt.TextSelectableByMouse)
        self.note4.setObjectName("note4")
        self.verticalLayout_6.addWidget(self.note4)
        self.horizontalLayout_12.addWidget(self.frame_9)
        self.relay3 = QtWidgets.QCheckBox(self.frame_8)
...
"}")
        ...
        self.frame_6.setStyleSheet("background-color: rgba(255, 225, 255, 10);")
...
"}")
        ...
        self.label_title_13 = QtWidgets.QLabel(self.frame_7)
        self.label_title_13.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(14)
        font.setBold(False)
        self.label_title_13.setFont(font)
        self.label_title_13.setStyleSheet("QLabel{\n"
"color: rgb(8, 255, 206);\n"
"background-color: none;\n"
"}\n"
"QLabel:hover{\n"
...
"")
        ...
        self.label_title_13.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_title_13.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextEditable|QtCore.Qt.TextSelectableByMouse)
        ...
        self.relay4 = QtWidgets.QCheckBox(self.frame_6)
...
"}")
        ...
        self.label_credit = QtWidgets.QLabel(self.frame_10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.note1.setText(_translate("MainWindow", "Note:"))
        self.label_title_10.setText(_translate("MainWindow", "Channel 1:"))
        self.note2.setText(_translate("MainWindow", "Note:"))
        self.label_title_14.setText(_translate("MainWindow", "Channel 1:"))
        self.note4.setText(_translate("MainWindow", "Note:"))
        self.label_title_12.setText(_translate("MainWindow", "Channel 1:"))
        self.label_title_13.setText(_translate("MainWindow", "Note:"))
        self.label_credit.setText(_translate("MainWindow", "#tht5hc  "))
